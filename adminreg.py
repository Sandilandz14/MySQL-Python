...
def myregister():
    ...
    sql = "INSERT INTO Admin(Fullname, Username, Password) VALUES (%s, %s, %s)"
    values = (fnm, usn, pwd)
...
mybutton1 = Button(root, text="Register Admin", command=myregister, fg="blue", bg="black", width=15).place(x=145,y=110)
mybutton2 = Button(root, text="Back", command=myback, fg="blue", bg="black", width=15).place(x=145,y=140)
root.mainloop()
